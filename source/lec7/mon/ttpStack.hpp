...
template <typename T, template <typename T, typename alloc = std::allocator<T>> class CONT> class Stack;
...
template <typename T, 
    template <typename T, typename alloc = std::allocator<T>> class CONT = std::deque>
  class Stack {
public:
